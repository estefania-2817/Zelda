...
ImageManager::ImageManager() {
    ...
    ofImage cactusSpriteSheet = ofImage("images/SpriteSheets/cactus.png");
    cactus.cropFrom(cactusSpriteSheet, 12, 103, 72, 95);
    ...
    newDungeon = ofImage("images/Maps/newDungeon.png");
    bonusDungeon = ofImage("images/Maps/bonusDungeon.png");
...
shared_ptr<DynamicEntityAnimations> ImageManager::getNewEnemyAnimations(){
    ...
    newEnemyAnimations->damage = getAnimationFromIndices(20, 38);
